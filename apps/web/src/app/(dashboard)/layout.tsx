...
function canAccessModule(
  user: { role: string; allowedModules?: string[] } | null,
  moduleId: string,
): boolean {
    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25m0 0h-2.25m0 0V4.5m0 0H9.75m2.5 0h2.25m0 0h2.25"
        />
      </svg>
    ),
  },
    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m9.86-2.076a4.5 4.5 0 00-1.242-7.244l-4.5-4.5a4.5 4.5 0 00-6.364 6.364L4.25 8.81"
        />
      </svg>
    ),
  },
  ...
  useEffect(() => {
    ...
    async function init() {
      ...
      if (user) {
        ...
        // Show onboarding wizard for new users (OWNER/ADMIN roles)
        if (
          ['OWNER', 'ADMIN', 'SUPER_ADMIN'].includes(user.role) &&
          !localStorage.getItem('torque_onboarding_complete')
        ) {
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                ...
                {currentUser?.role && (
                  <span
                    className={`inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-semibold uppercase tracking-wide border flex-shrink-0 ${ROLE_BADGE_COLORS[currentUser.role] || ROLE_BADGE_COLORS.VIEWER}`}
                  >
